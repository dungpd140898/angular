...
@Component({
  selector: 'app-task-sua-reactive',
  templateUrl: './task-sua-reactive.component.html',
  styleUrls: ['./task-sua-reactive.component.css']
})
export class TaskSuaReactiveComponent {
  form: FormGroup;
  projects: DuAn[];
  ...
  capnhatTask() {
    ...
    this.taskService.capnhatTask(updatedTask);
